...
const createRecipeObject = function (data) {
  ...
  return {
    ...
    ...(recipe.key && { key: recipe.key }) //Short circuits if recipe.key is faulty value (if it doesn't exist) then nothing happenss here but if is it here then will be returned this object key:recipe.key
  };
};
